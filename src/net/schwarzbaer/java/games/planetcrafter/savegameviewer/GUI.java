...
class GUI {
	...
	enum ActionCommand {
		ReloadSaveGame, OpenSaveGame, WriteReducedSaveGame, ScanSaveGame, ReloadSaveGameAutoSwitch,
		ShowEditAchievements, ShowMapShapesEditor,
		SetLabelLanguageDE, SetLabelLanguageEN,
		MemoryInfo
	}
